        ...
        <div class="work-main__right">
            <div class="work-info">
                <ul class="work-info__list list-reset">
                    ...
                    <div class="work-info__btn-whislist btn-wishlist">
                        <a href="#" target="_blank" class="btn-wishlist__link @if (!empty($inWishlist) && $inWishlist) btn-wishlist__active"@endif aria-label="Messenger">
                            <svg>
